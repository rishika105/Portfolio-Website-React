    ...
    <footer className="w-full relative bg-[#060606] text-white  py-8 sm:py-10 px-4 overflow-hidden">
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-8">
          {/* Left - Copyright */}
          <div className="text-xs sm:text-sm font-medium text-center md:text-left">
            © {new Date().getFullYear()} | All Rights Reserved
          </div>

          {/* Center - Email and Resume */}
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-6 text-xs sm:text-sm text-center">
            <a
          ...
          {/* Right - Signature */}
          <div className="text-xs sm:text-sm font-medium text-center md:text-right">
