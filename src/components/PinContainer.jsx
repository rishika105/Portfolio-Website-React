    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Main Content */}
          <div className={cn(
            "relative z-50 w-full h-full bg-gradient-to-b from-black to-gray-900 rounded-[20px] p-4",
            className
          )}>
            {children}
          </div>
...
// Keep the PinPerspective component the same as in your original code
